...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 17 16:42:57 2021
...
pcigale.sed_modules.get_module('deep_nebular')

module_list = ['sfhdelayed', 'bc03','deep_nebular','dustatt_modified_starburst','dl2014', 'redshifting']
...
deep_modules = [pcigale.sed_modules.deep_nebular]
module_parameters_to_fit = {'tau_main': {"type":"unif","min":1500,"max" :3000},
            ...
            'logU':{"type":"unif","min":-3,"max":1},
            'log_O_H':{"type":"unif","min":-5,"max":-2},
            'Age':{"type":"unif","min":1,"max":6},
}
...
path_wave = path_deep + 'dict_wavelength_lines.csv'
